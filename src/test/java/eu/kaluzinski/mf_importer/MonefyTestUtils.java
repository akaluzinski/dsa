...
public class MonefyTestUtils {
  ...
  public static List<AccountEntry> accountOutcomeState = List.of(
      new AccountEntry(LocalDate.of(2024, 1, 16), new Category("Housing"), 2210.0, "Rent", "mBank"),
      new AccountEntry(LocalDate.of(2024, 2, 1), new Category("Internet"), 119.0, "UPC", "mBank"),
